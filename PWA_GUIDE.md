# Guia de Instalação do My Finances como PWA
...
- **Ícone personalizado**: Utiliza o ícone da aplicação
...
- **Modo escuro**: Suporte a tema escuro que se adapta às preferências do sistema
...
5. **Atualizações automáticas**: Sempre tenha a versão mais recente sem precisar atualizar manualmente