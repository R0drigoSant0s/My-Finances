...
// Define interface para orçamentos
interface Budget {
  id: number;
  name: string;
  limit: number;
...
export default function NewTransactionModal({
  ...
  // Fechar dropdown ao trocar o tipo de transação
  useEffect(() => {
    setIsBudgetDropdownOpen(false);
  }, [type]);
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
                  placeholder="0,00"
                  required
                />
              </div>
