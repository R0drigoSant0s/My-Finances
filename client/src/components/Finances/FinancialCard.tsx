...
export default function FinancialCard({ 
  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-md border border-gray-200 dark:border-gray-800 overflow-hidden hover:bg-gray-50 dark:hover:bg-gray-800/70 transition-colors">
      <div className="px-4 py-3">
        <div className="flex justify-between items-center mb-1">
          <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">{title}</h3>
          <div className={`${getIconBgClass()} p-2 rounded-2xl`}>
            {getIcon()}
          </div>
        </div>
